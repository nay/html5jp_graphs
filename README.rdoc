...
== Install
  ...
  > git clone git://github.com/nay/html5jp_graphs.git vendor/plugins/html5jp_graphs && rm -rf vendor/plugins/html5jp_graphs/.git
...
Add :htmltjp_graphs as a helper in your controllers.
