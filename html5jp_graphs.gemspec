Gem::Specification.new do |s|
  ...
  s.version = "0.1"
  s.date = "2008-06-23"
  s.summary = "Rails Plugin for html5jp Graph Libraries."
  s.email = "y.ohba@everyleaf.com"
  s.homepage = "http://github.com/nay/html5jp_graphs"
  s.description = "html5jp_graphs is a Rails Plugin for html5jp graph libraries. It supports vertical bar chart, radar chart, pie chart, and line chart."
  s.has_rdoc = true
